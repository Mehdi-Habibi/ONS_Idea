...
public class TrafficInfo {
    ...
    /**
     * Creates a new Ons.TrafficInfo object.
     * 
     ...
     * 
     * @return the holdingTime attribute of the Ons.TrafficInfo object
     */
     ...
     * 
     * @return the rate attribute of the Ons.TrafficInfo object
     */
    int getRate() {
        return rate;
    }
    ...
    /**
     * Retrieves the class of service of the Ons.TrafficInfo object.
     * This information is useful for prioritizing traffic based on
     * application type.
     * 
     * @return the cos attribute of the Ons.TrafficInfo object
     */
    int getCOS() {
        return cos;
    }
     ...
     * 
     * @return the weight attribute of the Ons.TrafficInfo object
     */
    int getWeight() {
        return weight;
    }
